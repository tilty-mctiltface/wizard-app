      ...
      <div className="flex flex-col tablet:flex-row justify-center align-center items-center pt-20 pb-16">
        <div className={"rounded-xl relative rounded-xl overflow-hidden tablet:mr-8 mr-0 mb-4 " + Styles.borderAccent}>
          <div className="bg-gray-900 bg-opacity-70 absolute h-64 w-64 flex justify-center align-center items-center">
            <p className="text-9xl pb-3 accent-text font-bold font-face-texturina">?</p>
          </div>
          <img src={Wizard1} className="h-64 w-64"/>
        </div>
        <div className="w-auto tablet:w-5/12 accent-text font-face-texturina">
...
function Images(props) {
  return (
      <div className="grid tablet:grid-cols-2 tablet:grid-rows-4 xl:grid-cols-5 xl:grid-rows-2 gap-10 place-items-center mt-16 mr-12 ml-12">
        ...
        <img alt="Wizard" src={Wizard3} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard4} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard5} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard6} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard7} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard8} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard1} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
        <img alt="Wizard" src={Wizard2} className={`hidden tablet:block h-64 w-64 rounded-xl wizard-shadow cards-hover ${Styles.borderAccent} ${Styles.cardsHover}`}/>
      </div>
  )
}
...
function SocialsIcon(props) {
  return (
      <a className="social-link" href={props.link} target="_blank" rel="noreferrer">
...
function MenuThing(props) {
  return (
      <div className="flex flex-row justify-between align-center items-center pt-10">
        <div className="w-16 h-16">
          <svg width="" height="64" viewBox="0 0 750 1000" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={"flex flex-row justify-between items-center p-2 no-click " + Styles.addressBox}>
          ...
          <p className="font-face-texturina text-xl pl-4 pr-4">Connect</p>
        </div>
      </div>
  )
}
